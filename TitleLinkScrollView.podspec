#
#  Be sure to run `pod spec lint TitleLinkScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EagleZhangWeicheng/TitleLinkScrollView.git", :tag => "#{s.version}" }
